...
function MyAlxCards() {
    ...
    const handleLoginClick = () => {
      navigate('/login'); // Adjust this path to where your login page is located
    };
  // console.log(fetchData())
    return (
      <>
        <NavBar checkData={checkData}/>
        {checkData == 200 ?
        <>
          <div>
        ...
        <div className="bg-white p-10 rounded-lg shadow-lg text-center">
          <h1 className="text-2xl font-bold mb-6 text-gray-800">You should log in</h1>
          <button onClick={handleLoginClick} className="px-6 py-2 bg-blue-500 text-white rounded-full font-semibold hover:bg-blue-600 transition duration-300">
            Log In
          </button>
        </div>
      </div>
